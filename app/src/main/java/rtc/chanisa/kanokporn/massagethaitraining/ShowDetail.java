        ...
        switch (index) {
            case 0:
                ...
                strings[1] = "วิธีการนวด ใช้นิ้วหัวแม่มือกดเส้นกล้ามเนื้อที่คอ " +
                             "กดไล่เรียงไปด้านบนชิดฐานกะโหลกกดผู้นวดจะต้องใช้มือด้านที่อยู่ฝั่งตรงข้ามกับคอด้านที่จะกดและตั้งเข่าตรงข้ามกับมือด้านที่ใช้กดมืออีกข้างประคองที่หน้าผากกดนวดขึ้นด้านบนอย่างเดียวไม่กดนวดลง";
                break;
            case 1:
                ...
                strings[1] = "วิธีการนวด ๑.คว่ำมือ ใช้นิ้วหัวแม่มือกดบนกึ่งกลางแขนท่อนบนด้านนอก(แนวตกของกล้ามเนื้อต้นแขน)หันหน้าเข้าหาผู้ถูกนวด หงายมือวางนิ้วหัวแม่มือคู่กดตามแนวนิ้วกลาง เริ่มจากใต้ข้อศอกไปจนถึงบริเวณเหนือข้อมือ\n" +
                             "๒.คว่ำมือ ใช้นิ้วหัวแม่มือกดบนหน้าขาและขาด้านใน-ด้านนอก เริ่มจากเข่าลงไปกระดูกข้อเท้า ";
                break;
            case 2:
                ...
                strings[0] = "ผู้ถูกนวด นอนคว่ำยืดขาตรง " +
                             "ผู้นวด นั่งคุกเข่าคู่ด้านข้างของคนไข้";
                strings[1] = "วิธีการนวด นิ้วหัวแม่มือชนกัน นวดจากต้นคอลงมาจนถึงเอวหรือสะโพกช่วยทำให้คลายเส้น และลดอาการปวดหลัง";
                break;
            case 3:
                ...
                strings[1] = "วิธีการนวด นิ้วหัวแม่มือชนกันวางคู่ขนาน นวดบ่าลงมาจนถึงสะโพก";
                break;
            case 4:
                ...
                strings[1] = "วิธีการนวด นิ้วหัวแม่มือชนกัน และกดลงเบาๆบนหลังเท้าและฝ่าเท้าตั้งแต่ข้อเท้าลงมายังฝ่าเท้า";
                break;
            case 5:
                ints[0] = R.drawable.arm1;
